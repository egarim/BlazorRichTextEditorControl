...
namespace BlazorRichTextEditorControl.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class BlazorRichTextEditorControlModule : ModuleBase {
    public BlazorRichTextEditorControlModule() {
		// 
		// BlazorRichTextEditorControlModule
		// 
